(function ($){
	...
	$.fn.stepify = function(options){
		...
		submitBtnStr = '<div id="share"><a class="social">Share!</a><a onClick="shareTwitter()" class="social"><svg class="icon icon-twitter"><use xlink:href="#icon-twitter"></use></svg></a><a onClick="shareFacebook()" class="social"><svg class="icon icon-facebook2"><use xlink:href="#icon-facebook2"></use></svg></a></div>',
		divStr = '<div></div>';
